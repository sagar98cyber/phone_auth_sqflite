...
import 'package:phone_authentication/screens/tabbar.dart';
import 'package:phone_authentication/screens/userProfileScreen.dart';
import 'package:phone_authentication/utility/appColors.dart';
import 'package:phone_authentication/utility/appDimens.dart';
import 'package:phone_authentication/utility/utility.dart';
  ...
  void _signInWithPhoneNumber(String otp) async {
    ...
    if (await Utility.checkInternet()) {
      try {
        ...
        if (user != null) {
          global g = new global();
          global.pnumber = user.phoneNumber;
          print("tell me ${global.pnumber}");
          print(user);
          Navigator.pushReplacement(
              context, MaterialPageRoute(builder: (BuildContext context) => dtabarstore(mobile: user.phoneNumber)));
          /*Navigator.push(
            context,
            MaterialPageRoute(
